    ...
    <section class="choose-wrapper">
        <div class="container">
            <div class="choose-wrapp">
                ...
                <div class="choose-right" data-aos="fade-right" data-aos-duration="1000">
                    <div class="img-wrapper">
                        <div class="img-wrapp">
                            <img src="/src/assets/img/boy-3.png" alt="img">
                        </div>
                        <div class="background"></div>
                    </div>
                    <div  class="video-wrapp" @click="playVideo" :class="{playing : isPlaying}">
                        <img v-if="!isPlaying" class="preview" src="/src/assets/img/glasses-2.png" alt="video">
